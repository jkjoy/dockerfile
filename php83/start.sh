...
# 定义变量（使用空格分隔的字符串代替数组）
TYPECHO_URLS="https://jkjoy.github.io/dockerfile/php83/typecho/typecho.zip"
...
THEME_URLS="https://jkjoy.github.io/dockerfile/php83/typecho/farallon.zip https://cdn.jsdelivr.net/gh/jkjoy/dockerfile/php83/typecho/farallon.zip"
INSTALL_DIR="/app"
